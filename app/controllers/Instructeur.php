...
class Instructeur extends BaseController
{
    ...
    function maakActief($instructeurId)
    {
        ...
        session_start();
        $_SESSION["message"] = "Instructeur $instructeur->Voornaam $instructeur->Tussenvoegsel $instructeur->Achternaam is terug van verlof gemeld";
    ...
    function maakInactief($instructeurId)
    {
        ...
        session_start();
        $_SESSION["message"] = "Instructeur $instructeur->Voornaam $instructeur->Tussenvoegsel $instructeur->Achternaam is met verlof gemeld";
    ...
    function deleteInstructeur($instructeurId)
    {
        ...
        session_start();
        $_SESSION["message"] = "Instructeur $instructeur->Voornaam $instructeur->Tussenvoegsel $instructeur->Achternaam is succesvol verwijderd, en alle eerder toegewezen voertuigen zijn nu beschikbaar.";
